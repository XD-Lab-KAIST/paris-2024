...
export default function MainComp() {
  ...
  const [virtualSpeed, setVirtualSpeed] = useState(SPEED);
  ...
  useEffect(() => {
    ...
    setShowCrosshair(phase === 1 || phase === 3);
  }, [mouseDownCount, isStarted]);
  ...
  const phase = mouseDownCount % SINGLE_CYLCE;
  const crosshairMode = phase === 1 ? 'increasing' : phase === 3 ? 'decreasing' : 'none';
